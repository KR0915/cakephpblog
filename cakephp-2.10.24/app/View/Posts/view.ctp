...
<?php
echo $this->Form->create('Comment', array('label'=>'コメントを追加','action'=>'add'));
echo $this->Form->input('commenter',array('label'=>'制作者'));
echo $this->Form->input('body', array('label'=>'コメント','rows'=>3));
